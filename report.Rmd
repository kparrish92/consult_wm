...
ggsave(here("high_res", "listening_comprehension.png"), dpi = 600)
```
...
ggsave(here("high_res", "listening.png"), dpi = 600)
```
...
ggsave(here("high_res", "working_memory.png"), dpi = 600)
...
ggsave(here("high_res", "stroop_effect.png"), dpi = 600)
